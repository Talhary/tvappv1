...
return {title: title,urls:data };
}
downloadVideo('https://www.youtube.com/watch?v=wh4kGL1EIGM',120).then(async(data)=>{
 try {
  // await axios.get(data.urls.url, {responseType: 'arraybuffer'});
  console.log(data)
